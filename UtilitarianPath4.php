...
<div id="cdss-container">
    ...
    <div id="example13">
                ...
                <input type="radio" id="example4-stage1-utilitarian-ni" name="E4S1" value="U-E4S1-UTILITARIAN-ni" onclick="submitExamples4()" required></input>
                  <label class="example-option" for="example3-stage1-utilitarian-ni" onclick="submitExamples4()" >Swerve off road into the spectators avoiding the pack of athletes (Injuring <?php echo $variable11["Dead"];?>, killing <?php echo $variable10["Dead"];?>) </label><br>
                <input type="radio" id="example4-stage1-deontology-i" name="E4S1" value="U-E4S1-DEONTOLOGY-i" onclick="submitExamples4()">
                  <label class="example-option" for="example3-stage1-deontology-i" onclick="submitExamples4()">Continue onward and into the athletes (Injuring <?php echo $variable10["Dead"];?>, Killing <?php echo $variable11["Dead"];?>) </label><br>
