...
<div id="cdss-container">
    <form method="POST" action="example4.php">
        ...
        <div id="example8" style="display: none;">
          <P class="survey-paragraph">Another piece of information is revealed. The pedestrians which have entered the road are 2 school children running into the road to retrieve their ball while the third is their parent attempting to pull them back. Does this change your opinion on which should be saved? Should the car? </p>
        ...
        <div id="example9" style="display: none;">
          <P class="survey-paragraph">The final piece of information is revealed, you and your family are driving to a wedding when the children and parent step into the road. If you chose to avoid the pedestrians in step 2 does this affect your choice? </p>
