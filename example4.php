...
<div id="cdss-container">
    <form method="POST" action="exlikert.php">
          ...
          <div id="example13" style="display: none;">
                ...
                <input type="radio" id="example5-stage3-deontology-i" name="E5S1" value="E5S1-DEONTOLOGY-i" onclick="example14()">
                  <label class="example-option" for="example5-stage3-deontology-i" onclick="example14()"> Swerving off the road and kill the pedestrians on the pavement </label><br>
              </div>
              <div id="example14" style="display: none;">
                ...
                <input type="radio" id="example6-stage3-utilitarian-ni" name="E6S1" value="E5S1-UTILITARIAN-ni" onclick="likert1()"></input>
                  <label class="example-option" for="example6-stage3-utilitarian-ni" onclick="()"> Swerve off the road avoiding the pedestrians but kill all those in the car including yourself </label><br>
                <input type="radio" id="example6-stage3-deontology-i" name="E6S1" value="E5S1-DEONTOLOGY-i" onclick="likert1()">
                  <label class="example-option" for="example6-stage3-deontology-i" onclick="likert1()"> Continue the present course and hit the pedestrians  </label><br>
              </div>
              <div>
