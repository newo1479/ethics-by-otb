...
<div id="likert1">
            <div id="line">
                  <p class="survey-paragraph">1. It is important for the application of ethical theory to self-driving cars</p>
                  <div>
                   <input type="radio" id="likert1-1" name="L1" value="L1-1"required>
                   ...
                   <input type="radio" id="likert1-3" name="L1" value="L1-3">
                     <label class="example-option" for="likert1-3">Neither AGREE nor DISAGREE</label>
        ...
        <!--likert 2-->
              <div id="likert2" >
                <p class="survey-paragraph">2. Manufacturers should have different ethical programming for different parts of the world </p>
                <div>
                 <input type="radio" id="likert2-1" name="L2" value="L2-1"required>
                 ...
                 <input type="radio" id="likert2-3" name="L2" value="L2-3">
                   <label class="example-option" for="likert2-3">Neither AGREE nor DISAGREE</label>
        ...
        <!--likert 3-->
              <div id="likert3" >
                <p class="survey-paragraph">3. Pedestrians’ lives should be preserved over those in the vehicle</p>
                <div>
                 <input type="radio" id="likert3-1" name="L3" value="L3-1"required>
                 ...
                 <input type="radio" id="likert3-3" name="L3" value="L3-3">
                   <label class="example-option" for="likert3-3">Neither AGREE nor DISAGREE</label>
        ...
        <!--likert 4-->
              <div id="likert4" >
                <p class="survey-paragraph">4. The most ethical option is to not let the car intervene</p>
                <div>
                 <input type="radio" id="likert4-1" name="L4" value="L4-1"required>
                 ...
                 <input type="radio" id="likert4-3" name="L4" value="L4-3">
                   <label class="example-option" for="likert4-3">Neither AGREE nor DISAGREE</label>
        ...
        <!--likert 5-->
              <div id="likert5" >
                <p class="survey-paragraph">5. Those who are abiding by the law should have their lives preserved even if more casualties will result. </p>
                <div>
                 <input type="radio" id="likert5-1" name="L5" value="L5-1"required>
                 ...
                 <input type="radio" id="likert5-3" name="L5" value="L5-3">
                   <label class="example-option" for="likert5-3">Neither AGREE nor DISAGREE</label>
               ...
               <div id="likert6" >
                ...
                <div>
                 ...
                 <input type="radio" id="likert6-3" name="L6" value="L6-3">
                   <label class="example-option" for="likert6-3">Neither AGREE nor DISAGREE</label>
        ...
        <!--Likert 7-->
                <div id="likert7" >
                  <p class="survey-paragraph">7. Algorithms should reflect existing bias in society</p>
                  <div>
                   <input type="radio" id="likert7-1" name="L7" value="L7-1"required>
                   ...
                   <input type="radio" id="likert7-3" name="L7" value="L7-3">
                     <label class="example-option" for="likert7-3">Neither AGREE nor DISAGREE</label>
               ...
               <div id="likert8" >
                ...
                <div>
                 ...
                 <input type="radio" id="likert8-3" name="L8" value="L8-3" >
                   <label class="example-option" for="likert8-3" >Neither AGREE nor DISAGREE</label>
